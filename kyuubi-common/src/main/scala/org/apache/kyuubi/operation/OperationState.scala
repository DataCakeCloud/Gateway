...
object OperationState extends Enumeration {
  ...
  val INITIALIZED, PENDING, RUNNING, COMPILED, FINISHED, UPLOADED, UPLOAD_TIMEOUT, TIMEOUT,
      CANCELED, CLOSED, ERROR, UNKNOWN =
    Value

  val terminalStates: Seq[OperationState] =
    Seq(FINISHED, UPLOADED, TIMEOUT, CANCELED, CLOSED, ERROR)
