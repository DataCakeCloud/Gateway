...
object KyuubiReservedKeys {
  ...
  final val KYUUBI_SERVER_HOSTNAME_KEY = "kyuubi.server.hostname"
  ...
  final val SPARK_SQL_DEFAULT_DB_KEY = "spark.sql.default.dbName"

  // lakecat use
  final val LAKECAT_CATALOG_PROBE_FROM = "catalog.probe.from"
  final val LAKECAT_CATALOG_PROBE_CLUSTER = "catalog.probe.cluster"
  final val LAKECAT_CATALOG_PROBE_REAL_USER = "catalog.probe.userId"
  final val LAKECAT_CATALOG_PROBE_USER_GROUP = "catalog.probe.userGroup"
  final val LAKECAT_CATALOG_PROBE_TASK_ID = "catalog.probe.taskId"
  final val LAKECAT_CATALOG_PROBE_TASK_NAME = "catalog.probe.taskName"
}
