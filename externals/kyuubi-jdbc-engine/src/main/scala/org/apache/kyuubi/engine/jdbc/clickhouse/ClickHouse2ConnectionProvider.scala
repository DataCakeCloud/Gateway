...
class ClickHouse2ConnectionProvider extends JdbcConnectionProvider {

  override val name: String = classOf[ClickHouse2ConnectionProvider].getSimpleName

  override val driverClass: String = "ru.yandex.clickhouse.ClickHouseDriver"
